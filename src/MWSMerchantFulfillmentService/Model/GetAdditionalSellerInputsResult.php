...
require_once(dirname(__FILE__) . '/../Model.php');
 ...
 class MWSMerchantFulfillmentService_Model_GetAdditionalSellerInputsResult extends MWSMerchantFulfillmentService_Model
 {
     ...
     {
         $this->_fields = [
    'ShipmentLevelFields' => ['FieldValue' => [], 'FieldType' => ['MWSMerchantFulfillmentService_Model_AdditionalInputs'], 'ListMemberName' => 'member'],
    'ItemLevelFieldsList' => ['FieldValue' => [], 'FieldType' => ['MWSMerchantFulfillmentService_Model_ItemLevelFields'], 'ListMemberName' => 'member'],
    ];
