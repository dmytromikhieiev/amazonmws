...
require_once(dirname(__FILE__) . '/../Model.php');
 ...
 class MWSMerchantFulfillmentService_Model_GetEligibleShippingServicesResponse extends MWSMerchantFulfillmentService_Model
 {
     ...
     {
         $this->_fields = [
    'GetEligibleShippingServicesResult' => ['FieldValue' => null, 'FieldType' => 'MWSMerchantFulfillmentService_Model_GetEligibleShippingServicesResult'],
    'ResponseMetadata' => ['FieldValue' => null, 'FieldType' => 'MWSMerchantFulfillmentService_Model_ResponseMetadata'],
    'ResponseHeaderMetadata' => ['FieldValue' => null, 'FieldType' => 'MWSMerchantFulfillmentService_Model_ResponseHeaderMetadata'],
    ];
