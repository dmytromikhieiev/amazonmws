...
require_once(dirname(__FILE__) . '/../Model.php');
 ...
 class MWSMerchantFulfillmentService_Model_AvailableShippingServiceOptions extends MWSMerchantFulfillmentService_Model
 {
     ...
     {
         $this->_fields = [
    'AvailableCarrierWillPickUpOptions' => ['FieldValue' => [], 'FieldType' => ['MWSMerchantFulfillmentService_Model_AvailableCarrierWillPickUpOption'], 'ListMemberName' => 'AvailableCarrierWillPickUpOption'],
    'AvailableDeliveryExperienceOptions' => ['FieldValue' => [], 'FieldType' => ['MWSMerchantFulfillmentService_Model_AvailableDeliveryExperienceOption'], 'ListMemberName' => 'AvailableDeliveryExperienceOption'],
    ];
