...
require_once(dirname(__FILE__) . '/../Model.php');
 ...
 class MWSMerchantFulfillmentService_Model_CreateShipmentRequest extends MWSMerchantFulfillmentService_Model
 {
    ...
    'ShipmentRequestDetails' => ['FieldValue' => null, 'FieldType' => 'MWSMerchantFulfillmentService_Model_ShipmentRequestDetails'],
    ...
    'LabelFormatOption' => ['FieldValue' => null, 'FieldType' => 'MWSMerchantFulfillmentService_Model_LabelFormatOptionRequest'],
    'ShipmentLevelSellerInputsList' => ['FieldValue' => [], 'FieldType' => ['MWSMerchantFulfillmentService_Model_AdditionalSellerInputs'], 'ListMemberName' => 'member'],
    ];
