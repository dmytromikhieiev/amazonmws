...
require_once(dirname(__FILE__) . '/../Model.php');
 ...
 class MWSMerchantFulfillmentService_Model_Item extends MWSMerchantFulfillmentService_Model
 {
    ...
    'ItemLevelSellerInputsList' => ['FieldValue' => [], 'FieldType' => ['MWSMerchantFulfillmentService_Model_AdditionalSellerInputs'], 'ListMemberName' => 'member'],
    'ItemWeight' => ['FieldValue' => null, 'FieldType' => 'MWSMerchantFulfillmentService_Model_Weight'],
    'ItemDescription' => ['FieldValue' => null, 'FieldType' => 'string'],
    ];
